 ...
 * {@link #onSuccess(String)} method is designed to
...
public class AsyncHttpResponseHandler {
	 ...
	 */
	public void onSuccess(Header[] responseHeader,String content) {
	}
	 ...
	 *            the body of the HTTP response from the server
	 */
	public void onSuccess(int statusCode, Header[] responseHeader,String content) {
		onSuccess(responseHeader,content);
	}
	...
	protected void sendSuccessMessage(int statusCode, Header[] responseHeader, String responseBody) {
		sendMessage(obtainMessage(SUCCESS_MESSAGE, new Object[] { new Integer(statusCode),
				responseBody }));
	}
	...
	protected void handleSuccessMessage(int statusCode, Header[] responseHeader,String responseBody) {
		onSuccess(statusCode, responseHeader,responseBody);
	}
