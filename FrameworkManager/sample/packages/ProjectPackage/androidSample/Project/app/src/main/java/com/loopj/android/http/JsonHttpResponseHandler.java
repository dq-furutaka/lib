...
public class JsonHttpResponseHandler extends AsyncHttpResponseHandler {
	...
	public void onSuccess(int statusCode, Header[] responseHeader,JSONObject response) {
		onSuccess(responseHeader,response);
	}
	...
	protected void handleSuccessJsonMessage(int statusCode, Header[] responseHeader,Object jsonResponse) {
		if (jsonResponse instanceof JSONObject) {
			onSuccess(statusCode,responseHeader, (JSONObject) jsonResponse);
		} else if (jsonResponse instanceof JSONArray) {
			onSuccess(statusCode,responseHeader, (JSONArray) jsonResponse);
		} else {
